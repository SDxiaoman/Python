...
font = ImageFont.truetype('C:\\Users\\Administrator\\Desktop\\abc_test.TTF', 15, encoding='utf-8')
# Image模块创建一个图片对象
...
# python2
#draw.multiline_text((space,space), str(tab_info, 'utf-8'), fill=(255,255,255), font=font)
# python3
draw.multiline_text((space,space), tab_info, fill=(255,255,255), font=font)
#用当前的日期作为图片名称
picture_name=str(datetime.date.today())+".png"
print(picture_name)
im_new.save(picture_name, "PNG")
del draw